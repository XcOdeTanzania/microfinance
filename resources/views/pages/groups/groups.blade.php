                ...
                <form class="form-horizontal" method="get" action="">
                    <fieldset>
                        <div class="form-group row"><label class="col-md-2 col-form-label" for="input-id-1">Branch</label>
                            <div class="col-md-6">
                                <select aplaceholder="Select" name="branch" onchange="setOfficers(this);" class="form-control" id="branch">
                    ...
                    <fieldset>
                        <div class="form-group row"><label class="col-md-2 col-form-label" for="input-id-1">Loan Office</label>
                            <div class="col-md-6">
                                <select onchange="updateGroupTable(this);" name="loanOfficer" class="form-control" id="loanOfficer">                 
...
@section('scripts')
<script src="{{ asset('angle/js/samis/groups.js') }}">
</script>
@endsection