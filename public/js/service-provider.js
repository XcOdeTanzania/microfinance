  ...
  methods: {
    getGroups: function getGroups() {
      ...
      Container.resolve("groups").then(function (data) {
        ...
        _this.branches = data.branches; // console.log(this.groups);
                            ...
                            [
                              ...
                              _vm._l(_vm.branches, function(branch) {
                                return _c(
                                  ...
                                  {
                                    domProps: {
                                      value: JSON.stringify(branch.users)
                                    }
                                  },
                                  [
                                    _vm._v(
  ...
  function() {
    ...
    return _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("tbody", { attrs: { id: "groupTableBody" } }, [
          _vm._v(
...
__webpack_require__(/*! @Service/groups */ "./resources/js/services/groups.js");
